...
// TraceIDFunc represents a function that can return the trace
// id from the specified context.
...
func New(w io.Writer, minLevel Level, serviceName string, traceIDFunc TraceIDFunc) *Logger {
	return new(w, minLevel, serviceName, traceIDFunc)
}

// NewWithHandler returns a new log for application use
// with the underlying handler.
...
// /////////////////////////////////////////////////////////////////
func new(w io.Writer, minLevel Level, serviceName string, traceIDFunc TraceIDFunc) *Logger {
	// Convert the file name to just name.ext which this key/value is logged.
